...
class BSTView(BaseSubPage):
    ...
    def subpage_init(self):
        ...
        self.btn_search = self.add_btn("查找")
    ...
    def add_node(self, node_id, value, pos):
        ...
        node_item = STreeNodeItem(node_id, value)
...
class STreeNodeItem(QGraphicsObject):
    def __init__(self, node_id, value, parent=None):
        super().__init__(parent)
        self.node_id = node_id
        self.value = str(value)
        self.color = COLORS["norm"]
